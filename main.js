...
createWindow = () => {
    const window = new BrowserWindow({
        width: 1280,
        height: 720,
        title: 'ServiceNow Desktop',
        icon: __dirname + '/images/ServiceNow.ico',
    ...
    if (url) {
        ...
        prompt({
            title: 'ServiceNow Desktop',
            label: 'URL:',
            value: 'https://customer.service-now.com',
            inputAttrs: {
                type: 'url'
            },
            type: 'input',
    ...
    tray.setToolTip('ServiceNow Desktop')
    tray.setTitle('ServiceNow Desktop')
